...
public class PermisosFixture extends FixtureScript{
	...
	protected void execute(ExecutionContext executionContext) {
		...
		*/
		...
		create("usuario_tecnico","dom.solicituddeserviciotecnico:SolicitudServicioTecnico:tecnicoAsignado:r",executionContext);
		create("usuario_tecnico","dom.solicituddeserviciotecnico:SolicitudServicioTecnico:documentoDeSolucion:r",executionContext);
		...
		create("usuario_tecnico","dom.netbook:Netbook:imprimirContratoDeComodato:*",executionContext);
		create("usuario_tecnico","dom.netbook:Netbook:imprimirContratoDeCesion:*",executionContext);
		...
		create("usuario_tecnico","dom.directivo:Directivo:netbook:r",executionContext);
		...
		create("usuario_docente","dom.notificaciones:SolicitudTramiteDeMigracion:imprimir:*",executionContext);
